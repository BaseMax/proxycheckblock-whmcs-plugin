...
print "Hi\n";
$getcwd = getcwd();
$getcwd = isset($getcwd) ? $getcwd : '.';
/*
if (file_exists($getcwd.'/siavashblock/detector.php')) {
	include_once($getcwd.'/siavashblock/detector.php');
} elseif (file_exists($getcwd.'/../siavashblock/detector.php')) {
	include_once($getcwd.'/../siavashblock/detector.php');
} else {
	include_once($getcwd.'/../../siavashblock/detector.php');
}
